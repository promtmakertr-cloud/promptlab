...
export default function Home() {
  ...
  // 🔥 YENİ: SAF BROWSER YÖNLENDİRMESİ (404 VE URL HATASINI ÇÖZEN KISIM) 🔥
  const AIFormButton = ({ url, icon, name }) => (
    <button 
      ...
      onClick={(e) => {
        ...
        // Next.js router'ı bypass edip native olarak yeni sekme açıyoruz
                  ...
                  {!loading && result && (
                    <div style={{ marginTop: '35px', paddingTop: '20px', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
                      ...
                      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
                        {!isVisual ? (
                          <>
                            {/* MARKDOWN LİNKLERİ BURADA DÜZELTİLDİ */}
